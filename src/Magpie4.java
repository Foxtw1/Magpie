    ...
    public String getResponse(String statement) {
        ...
        if (statement.length() == 0) {
            ...
            response = "Tell me more about your family.";
                ...
                || findKeyword(statement, "chemistry") >= 0
                || findKeyword(statement, "physics") >= 0) {
            response = "So you are interested in science?";
        }
        else if (findKeyword(statement, "french") >= 0
            || findKeyword(statement, "spanish") >= 0
            || findKeyword(statement, "german") >= 0
            || findKeyword(statement, "russian") >= 0) {
            response = "You are interested in languages? I am interested in Java.";
        }
        else if (findKeyword(statement, "do you like me?") >= 0
            || findKeyword(statement, "am i cool?") >= 0
            || findKeyword(statement, "will you marry me?") >= 0) {
            response = "No.";
        }
        else if (findKeyword(statement, "confuse") >= 0
            || findKeyword(statement, "confusing") >= 0) {
            response = "You confuse me.";
        }
